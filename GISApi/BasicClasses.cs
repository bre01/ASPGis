...
namespace My.GIS
{
    ...
    */
    ...
    public class GISFeature
    {
        ...
        public GISSpatial spatialPart { set; get; }
        public GISAttribute attributePart { set; get; }
    ...
    {
        public ArrayList values { get; set; } = new ArrayList();
    ...
    {
        public GISVertex centroid { get; set; }
        public GISMapExtent mapExtent { get; set; }
    ...
    public class GISMapExtent
    {
        ...
        public GISVertex MapBottomLeft { get; set; }
        public GISVertex MapUpRight { get; set; }
    ...
    public class Layer
    {
        ...
        public GISMapExtent Extent { get; set; }
        public bool DrawAttributeOrNot { get; set; } = false;
        public int LabelIndex { get; set; }
        public S ShapeType { get; set; }
        public List<GISFeature> _features { get; set; } = new List<GISFeature>();
        public List<GISField> Fields { get; set; }
        public List<GISFeature> Selection { get; set; } = new List<GISFeature>();
    ...
    public static class CalTool
    {
        ...
        public static DataTable ReadDBF(String dbfFilename)
        {
            ...
            using (DbConnection = new DbConnectionStringBuilder(constr))
